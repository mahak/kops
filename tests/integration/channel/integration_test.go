...
func TestFindImage(t *testing.T) {
	...
	grid := []struct {
		...
		},
		{
			...
			Architecture:      "amd64",
			ExpectedImage:     "099720109477/ubuntu/images/hvm-ssd-gp3/ubuntu-resolute-26.04-amd64-server-20210315",
		},
		{
			KubernetesVersion: "1.20.1",
			Architecture:      "arm64",
			ExpectedImage:     "099720109477/ubuntu/images/hvm-ssd-gp3/ubuntu-resolute-26.04-arm64-server-20210315",
		},
	}
	for _, g := range grid {
		kubernetesVersion := semver.MustParse(g.KubernetesVersion)
